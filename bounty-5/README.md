...
2. **Configure** the `Config` node: set `githubRepo` (`owner/repo`), `slackWebhookUrl`, and `language` (`EN` or `FR`). The sponsor-pinned model remains `claude-sonnet-4-20250514`.
...
- Calls Anthropic's Messages API with `claude-sonnet-4-20250514`, exactly as specified by the bounty.
